...
const about = () => {
  ...
  p.textContent =
    "I thrive on growth, challenges, and continuous learning. Transitioning into software development has fueled my passion for building meaningful solutions and working on projects that make an impact. With a background in customer service and leadership, I’ve developed strong problem-solving and communication skills that translate seamlessly into tech. I enjoy collaborating across teams, building strong relationships, and bringing a positive attitude to every project. As I embrace new technologies and expand my creativity in this field, I’m eager to work on a team where innovation, collaboration, and making a difference are at the heart of what we do.";

  pHobbies.textContent =
    "I’m a passionate foodie who loves exploring new restaurants and revisiting favorites, with Manhattan as my go-to for nostalgic walks. Boxing is my therapy—it keeps me strong and confident. I hope to own my dream piano one day and revisit the classical pieces I once played. When the weather is right, nothing beats the thrill of riding my motorcycle—my preferred mode of transportation, so punctuality is never a concern.";
...
const project = (projects) => {
  ...
  container.addEventListener("click", (e) => {
    ...
    dialog
      ? dialog.showModal()
      : console.error(`Dialog for project ${projectId} not found.`);
  });
};
